...
/**
 * Class ilCloudStorageGroupedListGUI
 *
 ...
 */
class ilCloudStorageGroupedListGUI extends ilGroupedListGUI
{
     ...
     * @param string $a_add_class
     */
    public function addGroupHeader($a_content, $a_add_class = ""): void
    {
        $this->count++;
